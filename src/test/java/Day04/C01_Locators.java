...
public class C01_Locators {
    ...
    public void locatorStratejies() {
        ...
        //id,mane, class, tag, link text, partial link text, css selector , xpath
        ...
        WebElement searchFiled = driver.findElement(By.id("twotabsearchtextbox"));  //elementi locate ettik
    ...
    public void name() {
        ...
        WebElement searchFiled = driver.findElement(By.name("field-keywords"));
    }
