...
// Okunacak excel dosyamizin pathi
        String path = System.getProperty("user.dir") + "\\src\\test\\resources\\excelData.xlsx";  //projenin content root'u user.dir ile alinir.geri kalan kismi icin excelData.xlsx ustunde

        // Path kullanilarak olusturulan file input stream objesi
        FileInputStream fis = new FileInputStream(path);                                          //sag tikla AbsolutePath'den copy alinir.src'den sonrasi yazilir.
